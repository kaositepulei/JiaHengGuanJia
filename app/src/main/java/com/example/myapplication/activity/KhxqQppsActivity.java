...
public class KhxqQppsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_khxq_qpps);
        ...
        jinrupeisong.setOnClickListener(new KhxqQppsActivityOnClickListeber());
    ...
    private class KhxqQppsActivityOnClickListeber implements View.OnClickListener {

        @Override
        public void onClick(View view) {
            if (view.getId() == R.id.jinrupeisong) {
                Intent in = new Intent(KhxqQppsActivity.this, ScqppsjlActivity.class);
                in.putExtra("kehu",yonghumingcheng.getText().toString());
                in.putExtra("Cus_id",(String) jsonArray.getJSONObject(0).get("CusNum"));
                in.putExtra("ContactTel",(String) jsonArray.getJSONObject(0).get("ContactTel"));
                startActivity(in);
            }
        }
    }
