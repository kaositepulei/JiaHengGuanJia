...
public class KhxqYpActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_khxq_yp);
        ...
        jinrupeisong.setOnClickListener(new KhxqYpActivityOnClickListeber());
    ...
    private class KhxqYpActivityOnClickListeber implements View.OnClickListener {

        @Override
        public void onClick(View view) {
            if (view.getId() == R.id.jinrupeisong) {
                Intent in = new Intent(KhxqYpActivity.this, YpActivity.class);
