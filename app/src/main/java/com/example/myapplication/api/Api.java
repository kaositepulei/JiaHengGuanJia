...
public class Api {
    ...
    public static Api config(String url, JSONObject data) {
    ...
    public void postRequest(Context context, final TtitCallback callback) throws JSONException {
